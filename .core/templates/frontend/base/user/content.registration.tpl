<div class="content-middle3 user-container">
<!--{if $show_success_greeting}-->
	<h3>Регистрация завершена, на ваш e-mail было выслано письмо для активации аккаунта.</h3>
<!--{else}-->
    <h3 class="h3-colored">Регистрация</h3>
...
<!--{*
        <!-- user_city -->
        <li>
            <!--{if isset($err.user_city)}-->
                <div class="err"><!--{$err.user_city}--></div>
            <!--{/if}-->
            <label>Город*</label>
            <input name="_input_user_city" value="<!--{$vars.user_city|escape}-->" class="text" type="text"/>
        </li>
 *}-->
        <!-- user_country_id -->
        <li>
